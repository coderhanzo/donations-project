...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='created_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='campaigns', to='users.institutionadmin'),
        ),
        migrations.AddField(
            model_name='monetarycampaign',
            name='institution',
        ...
        migrations.AddField(
            model_name='monetarycampaign',
            name='last_edited_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='edited_campaigns', to='users.institutionadmin'),
        ),
        migrations.AddField(
            model_name='monetarycampaign',
            name='subscribers',

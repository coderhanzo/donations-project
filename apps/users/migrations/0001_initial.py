    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(blank=True, max_length=255, null=True, verbose_name='Institution Email')),
                ...
                ('contact_person_email', models.CharField(blank=True, max_length=200, null=True, verbose_name='Contact Person email')),
                ('institution_certificate', models.FileField(blank=True, null=True, upload_to='', verbose_name='Institution Certificate')),
                ('institution_license', models.FileField(blank=True, null=True, upload_to='', verbose_name='Institution License')),
            ],
        ),
        migrations.CreateModel(
            name='User',

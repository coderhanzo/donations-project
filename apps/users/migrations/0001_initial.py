    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution_name', models.CharField(blank=True, max_length=255, null=True, unique=True, verbose_name='Institution Name')),
                ('institution_email', models.EmailField(blank=True, max_length=255, null=True, unique=True, verbose_name='Institution Email')),
                ('phone_number', models.CharField(blank=True, max_length=255, null=True, verbose_name='Institution Phone')),

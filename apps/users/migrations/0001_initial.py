    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.CharField(blank=True, choices=[('bsystems_admin', 'Bsystems Admin'), ('institution_admin', 'Institution Admin'), ('institution_user', 'Institution User')], default='institution_user', max_length=50, null=True, verbose_name='Roles')),

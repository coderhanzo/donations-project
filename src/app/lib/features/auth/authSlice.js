...
export const get_logged_in_user = createAsyncThunk(
    ...
    async (data, thunkAPI) => {
        try {
            const response = await apiClient.get('http://0.0.0.0:8000/api/auth/users/me/', { withCredentials: true })
...
export const login = createAsyncThunk(
    ...
    async (data, thunkAPI) => {
        try {
            const response = await apiClient.post('http://0.0.0.0:8000/api/auth/jwt/create/', data, { withCredentials: true })
...
export const register = createAsyncThunk(
    ...
    async (data, thunkAPI) => {
        ...
        try {
            ...
            const response = await apiClient.post('http://0.0.0.0:8000/api/auth/users/', data, { withCredentials: true })
...
export const logout = createAsyncThunk(
    ...
    async (data, thunkAPI) => {
        //change
        try {
            const response = await apiClient.get('http://0.0.0.0:8000/api/auth/users/logout/', { withCredentials: true })
...
export const reset_password = createAsyncThunk(
    ...
    async (data, thunkAPI) => {
        try {
            const response = await apiClient.post('http://0.0.0.0:8000/api/auth/users/reset_password/', data, { withCredentials: true })
            return response.data
        } catch (error) {
...
export const confirm_password = createAsyncThunk(
    ...
    async (data, thunkAPI) => {
        try {
            const response = await apiClient.post(`http://0.0.0.0:8000/api/auth/users/reset_password_confirm/`, data, { withCredentials: true })
            return response.data
        } catch (error) {
...
export const set_password = createAsyncThunk(
    ...
    async (data, thunkAPI) => {
        try {
            const response = await apiClient.post('http://0.0.0.0:8000/api/auth/users/set_password/', data, { withCredentials: true })
            return response.data
        } catch (error) {
            if (error.response.data.new_password) {
                error.message = error.response.data.new_password[0]
